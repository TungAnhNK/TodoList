...
function App() {
    ...
    const setTasksStatus = (taskId, status) => {
    ...
    return (
        <div className="container">
            ...
            <TaskList tasks={tasks} showIncomplete={showIncomplete} setTasksStatus={setTasksStatus} removeTask={removeTask} setShowIncomplete={setShowIncomplete} />
